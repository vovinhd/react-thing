...
interface ICheckUserExistsScreenProps {
    navigation: any
}

interface ICheckUserExistsScreenState {
    email: string,
    loading: boolean
}

class CheckUserExistsScreen extends Component<ICheckUserExistsScreenProps, ICheckUserExistsScreenState> {

    static navigationOptions = {
        title: 'Please sign in'
    };

    constructor(props: ICheckUserExistsScreenProps) {
        super(props);
        this.state = {
            loading: true,
            email: '',
