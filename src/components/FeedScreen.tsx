...
import {FlatList, FlexStyle, RefreshControl, StyleSheet} from 'react-native';
...
import {FeedPost} from "../types/GraphQLSchema"
...
class FeedWidget extends Component<IFeedScreenProps, IFeedWidgetState> {
    constructor(props) {
        super(props);
                            ...
                            return (
                                <FlatList refreshControl={
                                    ...
                                    />
                                          ...
                                          data={data.posts}
                                          keyExtractor={(item: DeepPartial<FeedPost>, index) => item.id.toString()}
                                          renderItem={({item}) => (
...
class PostWidget extends Component<IFeedScreenProps, IFeedScreenState> {
...
class FeedScreen extends Component<IFeedScreenProps, IFeedScreenState> {
...
interface INewPostWidgetState {
    title: string,
    body: string
}

class NewPostWidget extends Component<IFeedScreenProps, INewPostWidgetState> {
                    ...
                    <Mutation mutation={ADD_POST}>
                        {(addPost, {data}) => (
                            <Form>
                                ...
                                <FormItem floatingLabel>
                                    <Label>Text</Label>
                                    <Input onChangeText={(text) => this.setState({body: text})}
