...
export default class App extends React.Component {
    constructor(props) {
        ...
        this.drawLeaf = (key, { loc, rot, scale }) => {
            console.log(JSON.stringify({ key: key, t: { loc, rot, scale } }));
            const { w, h } = scale;
            const x = loc.x - w / 2;
            const y = loc.y - h / 2;
            return (React.createElement(Image, { key: key, style: [
                    styles.sprite,
                    {
                        top: y,
                        left: x,
    ...
    render() {
        ...
        return (React.createElement(View, { style: styles.container },
            ...
            React.createElement(View, null,
                React.createElement(Button, { style: styles.buttons, onPress: this.onPressAddLeaf, title: "+ Leaf", color: "#44aa44" }),
                React.createElement(Button, { style: styles.button, onPress: this.onPressSubLeaf, title: "- Leaf", color: "#aa4444" }),
                React.createElement(Text, null,
                    "Leafs: ",
                    this.state.leafCount))));
    }
}
App.navigationOptions = {
    title: 'Fortschritt',
    tabBarIcon: ({ focused, tintColor }) => (React.createElement(Icon, { name: 'leaf', y: true, style: { fontSize: 20, color: tintColor } })),
};
...
//# sourceMappingURL=TreeScreen.js.map